...
import pygame
from pygame.locals import * #imports all the modules from pygame
...
def main():
    ...
    SOUNDS['die']    = pygame.mixer.Sound('Gallery/audio/die' + soundExt)
    SOUNDS['hit']    = pygame.mixer.Sound('Gallery/audio/hit' + soundExt)
    SOUNDS['point']  = pygame.mixer.Sound('Gallery/audio/point' + soundExt)
    SOUNDS['swoosh'] = pygame.mixer.Sound('Gallery/audio/swoosh' + soundExt)
    SOUNDS['wing']   = pygame.mixer.Sound('Gallery/audio/wing' + soundExt)
